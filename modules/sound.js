...
export class SoundGenerator {
	...
	SAMPLE_LIBRARY = {
		...
		"Bass solo": [
			{ note: "A", octave: 1, file: "samples/Bass solo/Bass.pizz.A1-PB.wav" },
			{ note: "A", octave: 2, file: "samples/Bass solo/Bass.pizz.A2-PB.wav" },
			{ note: "A", octave: 3, file: "samples/Bass solo/Bass.pizz.A3-PB.wav" },
			{ note: "B", octave: 1, file: "samples/Bass solo/Bass.pizz.B1-PB.wav" },
			{ note: "B", octave: 2, file: "samples/Bass solo/Bass.pizz.B2-PB.wav" },
			{ note: "B", octave: 3, file: "samples/Bass solo/Bass.pizz.B3-PB.wav" },
			{ note: "Bb", octave: 1, file: "samples/Bass solo/Bass.pizz.Bb1-PB.wav" },
			{ note: "Bb", octave: 2, file: "samples/Bass solo/Bass.pizz.Bb2-PB.wav" },
			{ note: "C", octave: 2, file: "samples/Bass solo/Bass.pizz.C2-PB.wav" },
			{ note: "C", octave: 3, file: "samples/Bass solo/Bass.pizz.C3-PB.wav" },
			{ note: "D", octave: 2, file: "samples/Bass solo/Bass.pizz.D2-PB.wav" },
			{ note: "Db", octave: 2, file: "samples/Bass solo/Bass.pizz.Db2-PB.wav" },
			{ note: "Db", octave: 3, file: "samples/Bass solo/Bass.pizz.Db3-PB.wav" },
			{ note: "E", octave: 2, file: "samples/Bass solo/Bass.pizz.E2-PB.wav" },
			{ note: "Eb", octave: 1, file: "samples/Bass solo/Bass.pizz.Eb1-PB.wav" },
			{ note: "Eb", octave: 2, file: "samples/Bass solo/Bass.pizz.Eb2-PB.wav" },
			{ note: "F", octave: 1, file: "samples/Bass solo/Bass.pizz.F1-PB.wav" },
			{ note: "F", octave: 2, file: "samples/Bass solo/Bass.pizz.F2-PB.wav" },
			{ note: "F", octave: 3, file: "samples/Bass solo/Bass.pizz.F3-PB.wav" },
			{ note: "G", octave: 2, file: "samples/Bass solo/Bass.pizz.G2-PB.wav" },
			{ note: "Gb", octave: 2, file: "samples/Bass solo/Bass.pizz.Gb2-PB.wav" },
			{ note: "Gb", octave: 3, file: "samples/Bass solo/Bass.pizz.Gb3-PB.wav" },
		],
		"Xylophone": [
